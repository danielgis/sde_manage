...
if __name__ == '__main__':
    ...
    params[INCLUDE_SYSTEM] = arcpy.GetParameterAsText(2)
    params[DELTA_ONLY] = arcpy.GetParameterAsText(3)
    params[ANALYZE_BASE] = arcpy.GetParameterAsText(4)
    params[ANALYZE_DELTA] = arcpy.GetParameterAsText(5)
    params[ANALYZE_ARCHIVE] = arcpy.GetParameterAsText(6)
